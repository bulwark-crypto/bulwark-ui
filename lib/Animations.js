...
export const pulse = color => props => keyframes`
  0% { box-shadow: 0 0 0 0 ${rgba(props.theme[color], 0.4)}; }
  70% { box-shadow: 0 0 0 10px ${rgba(props.theme[color], 0)}; }
  100% { box-shadow: 0 0 0 0 ${rgba(props.theme[color], 0)}; }
`
